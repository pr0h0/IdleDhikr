...
export default function SettingsPage() {
  ...
  const { resetGuides } = useGuideStore();
  const {
    vibrationEnabled,
    toggleVibration,
    dailyResetTime,
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <PageGuide
        ...
        description={t("guides.settingsDesc")}
      />
      ...
      <h2 className="text-lg font-semibold mt-6 mb-2">{t("uiPreferences")}</h2>
      <div className="bg-white dark:bg-slate-800 rounded-xl p-4 space-y-4 shadow-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <RotateCcw className="w-5 h-5 text-slate-500" />
            <span className="font-medium">{t("resetGuides")}</span>
          </div>
          <button
